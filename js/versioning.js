let VERSION_KEY="yt_studio_script_versions";function initVersioning(){var e,t=document.querySelector(".script-tools");t&&((e=document.createElement("button")).className="secondary-button small",e.title="Version History",e.innerHTML='<i class="fa-solid fa-clock-rotate-left"></i> History',e.addEventListener("click",showHistoryModal),t.prepend(e)),setInterval(saveVersion,3e4),document.addEventListener("keydown",e=>{var t;(e.ctrlKey||e.metaKey)&&"s"===e.key&&(t=document.getElementById("studio-root"))&&"block"===t.style.display&&(e.preventDefault(),saveVersion(!0))})}function saveVersion(t=!1){var o=document.querySelectorAll(".script-textarea");let s={},i=!1;if(o.forEach(e=>{s[e.dataset.section]=e.value.trim(),0<e.value.trim().length&&(i=!0)}),i){let e=JSON.parse(localStorage.getItem(VERSION_KEY)||"[]");0<e.length&&(o=e[0],JSON.stringify(o.content)===JSON.stringify(s))?t&&alert("No changes to save."):(e.unshift({time:Date.now(),content:s,manual:t}),20<e.length&&(e=e.slice(0,20)),localStorage.setItem(VERSION_KEY,JSON.stringify(e)),t&&alert("Script saved successfully!"))}}function showHistoryModal(){let e=JSON.parse(localStorage.getItem(VERSION_KEY)||"[]"),s=`
