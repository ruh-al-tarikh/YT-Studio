...
`,i=path.join(__dirname,"../enhancement-report.md"),fs.writeFileSync(i,t),console.log("📄 Report saved to: "+i),!0}catch(e){console.log("Error fetching YouTube data: "+e.message)}return!1}async function analyzeWithCustomSearch(){console.log("\n🔍 Attempting Custom Search API...");encodeURIComponent("site:github.com YT-Studio improvement tips"),GOOGLE_API_KEY;return console.log("⚠️ Custom Search requires a Search Engine ID. Skipping."),!1}function generateLocalReport(){console.log("\n📝 Generating local enhancement report...");var e=`# Auto-Enhancement Report
